...
replaceWithTheta  <- function( rtrn, theta, direction ){
...
calcTheta         <- function( rtrn, pctile, direction ){
  
  if( direction == "neg" ){
    theta = quantile(rtrn, pctile)[[1]]
  } else {
    theta = quantile(rtrn, 1 - pctile)[[1]]
  }
...
# firstLeg is extremely underperforming, secondLeg is extremely outperforming
pPairs <- list(
...
FofR1Neg <- function( r1, p1, epsilon1, sigma1 ){
  
  1 - p1 * ( ( 1 + epsilon1 * ( theta1 - r1 ) / sigma1 ) )^(-1/epsilon1) 
  
}

FofR2Pos <- function( r2, p2, epsilon2, sigma2 ){
  
  1 - p2 * ( ( 1 + epsilon2 * ( r2 - theta2 ) / sigma2 ) )^(-1/epsilon2) 
  
}

ZofR1Neg <- function( r1, p1, epsilon1, sigma1 ){
  
  - 1 / ( log( FofR1Neg( r1, p1, epsilon1, sigma1 )))
  
}

ZofR2Pos <- function( r2, p2, epsilon2, sigma2 ){
  
  - 1 / ( log( FofR2Pos( r2, p2, epsilon2, sigma2 )))
  
}

expDependenceFct <- function( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ){
  
  exp( -( ZofR1Neg(r1, p1, epsilon1, sigma1)^(-1/alpha) + ZofR2Pos(r2, p2, epsilon2, sigma2)^(-1/alpha))^alpha )
  
}


K1Neg <- function( r1, p1, epsilon1, sigma1 ){
  
  - p1/sigma1 * ( (1 + epsilon1 * (theta1-r1)/sigma1)^(-(1+epsilon1)/epsilon1) ) * ZofR1Neg(r1, p1, epsilon1, sigma1)^2 * exp(1 / ZofR1Neg( r1, p1, epsilon1, sigma1))
  
}


K2Pos <- function( r2, p2, epsilon2, sigma2 ){
  
  - p2/sigma2 * ( (1 + epsilon2 * (r2 - theta2 )/sigma2)^(-(1+epsilon2)/epsilon2) ) * ZofR2Pos(r2, p2, epsilon2, sigma2)^2 * exp(1 / ZofR2Pos( r2, p2, epsilon2, sigma2))
  
}

deltaDdeltaR1Neg = function( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha){
  
  ( ZofR1Neg( r1, p1, epsilon1, sigma1)^(-1/alpha) + ZofR2Pos(r2, p2, epsilon2, sigma2)^(-1/alpha) )^(alpha - 1) * ZofR1Neg( r1, p1, epsilon1, sigma1)^(-(1/alpha) - 1)
  
}

deltaDdeltaR2Pos = function( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha){
  
  ( ZofR1Neg( r1, p1, epsilon1, sigma1)^(-1/alpha) + ZofR2Pos(r2, p2, epsilon2, sigma2)^(-1/alpha) )^(alpha - 1) * ZofR2Pos(r2, p2, epsilon2, sigma2)^(-(1/alpha) - 1)
  
}

delta2DdeltaR1deltaR2Cross = function( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha){
  
  ((alpha-1)/alpha) * (( ZofR1Neg( r1, p1, epsilon1, sigma1)^(-1/alpha) + ZofR2Pos(r2, p2, epsilon2, sigma2)^(-1/alpha) )^(alpha - 2)) * ZofR1Neg( r1, p1, epsilon1, sigma1)^(-(1/alpha) - 1) * ZofR2Pos(r2, p2, epsilon2, sigma2)^(-(1/alpha) - 1)
...
likelihood0_1 <- function( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ){
  ...
  -expDependenceFct( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ) * deltaDdeltaR2Pos( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ) * K1Pos( r2, p2, epsilon2, sigma2 )
  
}

likelihood1_0 <- function( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ){
  
  -expDependenceFct( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ) * deltaDdeltaR1Neg( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ) * K1Neg( r1, p1, epsilon1, sigma1 )
...
likelihood1_1 <- function( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ){
  ...
  expDependenceFct( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ) * ( deltaDdeltaR1Neg( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ) * deltaDdeltaR2Pos( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha ) - delta2DdeltaR1deltaR2Cross( r1, r2, p1, epsilon1, sigma1, p2, epsilon2, sigma2, alpha) ) * K1Neg( r1, p1, epsilon1, sigma1 ) * K1Pos( r2, p2, epsilon2, sigma2 )
...
for(i in 1:length(pPairs$firstLeg)){
  ...
  for(j in 1:length(pThresholdsUpper)){
    ...
    theta1 = calcTheta( dfReturnDataTmp[, c(thisFirstLeg)], pctile, "neg")
    theta2 = calcTheta( dfReturnDataTmp[, c(thisSecondLeg)], pctile, "pos")
    
    R1 = replaceWithTheta(dfReturnDataTmp[,c(thisFirstLeg)], theta1, "neg")
    R2 = replaceWithTheta(dfReturnDataTmp[,c(thisSecondLeg)], theta2, "pos")
...
# write to file
filename             <- paste(c(pPathOut,"\\cross_excedances.csv"), collapse = "")
write.csv(x = dfOut, file = filename, row.names = FALSE, na = "")

filename             <- paste(c(pPathOut,"\\cross_excedances_tstats.csv"), collapse = "")
